...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/odd-sunset-56c9
```

A live public deployment of this template is available at [https://odd-sunset-56c9.templates.workers.dev](https://odd-sunset-56c9.templates.workers.dev)
